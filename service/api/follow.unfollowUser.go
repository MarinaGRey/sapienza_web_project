...
func (rt *_router) unfollowUser(w http.ResponseWriter, r *http.Request, ps httprouter.Params, ctx reqcontext.RequestContext) {
	...
	// execute action on the database
	err = rt.db.UnfollowUser(follower.ToDatabase(), followed.ToDatabase())
	if err != nil {
		ctx.Logger.WithError(err).Error("unfollowUser/db.UnfollowUser: executing error")
